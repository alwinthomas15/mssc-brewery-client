...
public class BreweryClient {
    ...
    public ResponseEntity saveNewCustomer(CustomerDto customerDto) {
        return restTemplate.postForEntity(apihost + CUSTOMER_PATH_V1, customerDto, CustomerDto.class);
    }

    public ResponseEntity updateCustomer(UUID uuid, CustomerDto customerDto) {
        HttpEntity<CustomerDto> entity = new HttpEntity<>(customerDto);
      return restTemplate.exchange(apihost+CUSTOMER_PATH_V1+uuid.toString(), HttpMethod.PUT, entity, CustomerDto.class);
    }
